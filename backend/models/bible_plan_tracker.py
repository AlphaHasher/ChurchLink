...
async def insert_user_bible_plan(
    uid: str, subscription: UserBiblePlanSubscription
) -> bool:
...
async def update_user_bible_plan_progress(
    uid: str, plan_id: str, progress: List[dict]
) -> bool:
    """
