...
async def get_event_registration_summary(event_id: str) -> Dict:
    """
    DEPRECATED: This function exposes other users' personal registration data.
    Use the new /registrations/summary endpoint instead which filters data by user.
    
    @deprecated This function violates privacy by returning all user registration details.
    """
    # SECURITY WARNING: This function exposes all users' registration data
    # It should no longer be used and will be removed in a future version
    try:
        ...
        # PRIVACY VIOLATION: This resolves names for ALL attendees
        # This should be replaced with user-filtered data
        enhanced_attendees = await resolve_registration_display_names(attendees)
        ...
        return {
            "success": True,
            "registrations": enhanced_attendees,  # PRIVACY VIOLATION: Contains all users' data
