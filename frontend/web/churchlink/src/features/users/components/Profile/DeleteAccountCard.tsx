    ...
    return (
        <>
            ...
            >
                <div className="flex items-center justify-between">
                    <div className="flex-1">
                        <h3 className="text-base font-semibold text-gray-900">{localize("Danger Zone")}</h3>
                        <p className="mt-1 text-sm text-gray-600">
                            {localize("Permanently delete your account and all associated data")}
                        </p>
                    </div>
                    <Button
            ...
            <AlertDialog open={open} onOpenChange={handleOpenChange}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        <AlertDialogTitle>{localize("Delete Account")}</AlertDialogTitle>
                        <AlertDialogDescription>
                            <div className="space-y-4 mt-4">
                                <p>{localize("This action cannot be undone. This will permanently delete your account and all associated data from our servers. You will be automatically refunded for, and unregistered from any upcoming events if applicable")}</p>
                                <p className="font-semibold text-gray-900">
                                    {localize("To confirm, please type your email address:")}
                                </p>
                                <div className="space-y-2">
                                    <p className="text-sm text-gray-600">{localize("Your email:")} {userEmail}</p>
                                    <Input
                    ...
                    <AlertDialogFooter>
                        ...
                        >
                            {loading ? localize("Deleting...") : localize("Confirm Delete")}
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
