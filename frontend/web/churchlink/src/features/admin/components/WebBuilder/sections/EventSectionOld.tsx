// I AM LITERALLY JUST STASHING THIS OLD STUFF FOR REFERENCE, ITS GONNA GET TAKEN BACK AND GIVEN A PERMANENT VACATION
...
const EventSectionOld: React.FC<EventSectionProps> = ({
  showFilters = true,
  eventName,
  lockedFilters,
  title,
...
export default EventSectionOld;
