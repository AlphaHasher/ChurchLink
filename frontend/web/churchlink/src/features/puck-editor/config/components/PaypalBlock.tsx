...
export type PaypalBlockPropsInner = {
  // Content
  heading: string;
  description: string;
  // Styling
...
export type PaypalBlockProps = PaypalBlockPropsInner & {
  layout?: {
    spanCol?: number;
    spanRow?: number;
    padding?: string;
  ...
  render: ({
    ...
    const handleOneTime = async () => {
      ...
      try {
        ...
        console.error("[PaypalBlock] one-time create failed:", e);
    ...
    const handleRecurring = async () => {
      ...
      try {
        ...
        console.error("[PaypalBlock] subscription create failed:", e);
          ...
          <Card className="border border-muted shadow-sm">
            <CardHeader className="space-y-1">
              <CardTitle className="flex items-center gap-2 text-lg font-semibold">
                ...
                <span style={{ ...headingFontStyles, color: headingColor || undefined }}>
                  {displayHeading}
                </span>
              </CardTitle>
              <p
              ...
              <div>
                ...
                >
                  <Label
                    ...
                    className={`flex cursor-pointer items-center gap-3 rounded-lg border px-3 py-3 text-left transition-all ${
                      mode === "one_time"
                ...
                <div className="space-y-4">
                  <div
                    className={`grid grid-cols-1 gap-4 ${
                      mode === "recurring" ? "sm:grid-cols-3" : "sm:grid-cols-2"
                    }`}
                  >
                    <div>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      placeholder="Add a note to appear alongside your donation (optional)…"
...
export const PaypalBlock = withLayout(PaypalBlockInternal);
