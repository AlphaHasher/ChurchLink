describe('Admin – Website Page Management', function () {
    beforeEach(function () {
        cy.loginWithBearer();
    ...
    it('loads without compile/runtime errors and renders the grid', function () {
    ...
    it('toggles visibility and opens editor without visual regressions', function () {
        cy.visit('/admin/webbuilder');
