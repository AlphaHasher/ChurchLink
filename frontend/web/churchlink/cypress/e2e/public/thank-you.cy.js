describe('Public – Thank You Page', function () {
    beforeEach(function () {
    ...
    it('loads thank you page and shows content', function () {
        cy.visit('/thank-you');
    ...
    it('handles missing payment context gracefully', function () {
    ...
    it('back to home button works', function () {
        cy.visit('/thank-you');
