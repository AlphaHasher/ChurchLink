...
describe('Public – Forms Pages', function () {
    beforeEach(function () {
    ...
    it('handles form not found gracefully', function () {
    ...
    it('verifies E2E auth bypass works (no 401 errors)', function () {
        ...
        cy.wait('@getForm', { timeout: 10000 }).then(function (interception) {
    ...
    it('payment success page loads', function () {
    ...
    it('payment cancel page loads', function () {
    ...
    it('forms are responsive', function () {
        cy.visit('/forms/contact', { failOnStatusCode: false });
