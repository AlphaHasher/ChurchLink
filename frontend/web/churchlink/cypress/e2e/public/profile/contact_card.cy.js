...
describe('Profile / Contact Info', function () {
    beforeEach(function () {
    ...
    it('shows an error and does not change the card when phone is invalid', function () {
        // Capture current values from the ContactCard
        captureContactSnapshot().then(function (initial) {
            openEditDialog();
    ...
    it('successfully updates phone and address with valid values', function () {
        openEditDialog();
        var validPhoneInput = '+1 (555) 111-2222';
        var newAddressLine1 = '123 Cypress Way';
        var newSuite = 'Suite 42';
        var newCity = 'Specville';
        var newState = 'SP';
    ...
    it('allows clearing the phone number and shows "—" in the card', function () {
        openEditDialog();
